...
# Form implementation generated from reading ui file 'RegisterPC.ui'
#
...
from src.orm.orm import get_session_maker,PC,User

class Ui_RegisterPC(object):
    ...
    def registerButtonPress(self):
        ...
        if res is "ok":
            Session = get_session_maker()
            session = Session()
            pcMember = PC(self.loginId.text(),self.password.text(),self.email.text(),self.loginId_2.text(),self.loginId_3.text(),self.loginId_4.text(),self.loginId_5.text(),self.loginId_6.text())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:24pt; font-weight:600;\">PC Member Registration</span></p></body></html>"))
